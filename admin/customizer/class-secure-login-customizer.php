...
if ( ! class_exists( 'Secure_Login_Customizer' ) ) {
	...
	class Secure_Login_Customizer {
		...
		public function secure_login_customize_register( $wp_customize ) {
			...
			$wp_customize->add_section(
				'secure_login_background_section',
				array(
					'priority' => 10,
			...
			$wp_customize->add_section(
				'secure_login_error_message_section',
				array(
					'priority' => 30,
			...
			$wp_customize->add_section(
				'secure_login_captcha_code_section',
				array(
					'priority' => 40,
			...
			$wp_customize->add_section(
				'secure_login_additional_css_section',
				array(
					'priority' => 45,
			...
			$wp_customize->add_setting(
				'secure_login_button_hover_border',
				array(
					'default'           => '#0074A2',
					'type'              => 'option',
					'capability'        => 'edit_theme_options',
			...
			$wp_customize->add_setting(
				'secure_login_form_text_font_size',
				array(
					'type'              => 'option',
					'capability'        => 'edit_theme_options',
					'sanitize_callback' => array( $this, 'secure_login_sanitize_string' ),
			...
			$wp_customize->add_setting(
				'secure_login_error_border_color',
				array(
					'default'           => '#dc3232',
					'type'              => 'option',
					'capability'        => 'edit_theme_options',
			...
			$wp_customize->add_setting(
				'secure_login_captcha_secretkey',
				array(
					'type'              => 'option',
					'capability'        => 'edit_theme_options',
					'sanitize_callback' => array( $this, 'secure_login_sanitize_string' ),
			...
			$wp_customize->add_setting(
				'secure_login_captcha_code_enable',
				array(
					'type'              => 'option',
					'capability'        => 'edit_theme_options',
					'sanitize_callback' => array( $this, 'secure_login_sanitize_checkbox' ),
